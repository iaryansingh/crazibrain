...
export const Footer = () => {
    return (
        <footer className="relative z-10 pt-20 pb-10 lg:pt-[120px] lg:pb-20 m-auto">
                ...
                <div className="flex flex-wrap -mx-4">
                  ...
                  <span className="mr-3 text-primary">
                    ...
                    <LinkGroup header="Resources">
                        ...
                        <NavLink link="./case-study" label="Case Studies" />
                    </LinkGroup>
                    <LinkGroup header="Company">
                        <NavLink link="../about" label="About Crazibrain" />
                    ...
                    <LinkGroup header="Products">
                        <NavLink link="/#" label="Iscan" />
                        <NavLink link="/#" label="KYC" />
                        <NavLink link="/#" label="MTOP" />
                        <NavLink link="/#" label="Other Products" />
                    </LinkGroup>
                    ...
                    <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                        <div className="w-full mb-10">
                            ...
                            <p className="text-base text-body-color">
                                {" "}
                                © {new Date().getFullYear()} Crazibrain Solutions{" "}
                            </p>
                        </div>
                    </div>
                </div>
